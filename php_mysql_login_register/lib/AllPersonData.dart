...
class _AllPersonDataState extends State<AllPersonData> {
  Future allPerson() async {
    var url = "http://192.168.43.82/image_upload_php_mysql/viewAll.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("La liste des images"),
      ),
      body: FutureBuilder(
        future: allPerson(),
                    ...
                    return Card(
                      child: ListTile(
                        title: Container(
                          ...
                          height: 300,
                          child: Image.network(
                              "http://192.168.43.82/image_upload_php_mysql/uploads/${list[index]['image']}"),
                        ),
